...
Future<void> initAppModule() async{
  ...
  instance.registerLazySingleton<StoreServerClient>(() => StoreServerClient(dioInstance, baseUrl: ApiConstants.storeBaseUrl));

  ///base remote
  instance.registerLazySingleton<BaseRemoteDataSource>(() => RemoteDataSource(instance<ServerClient>(),instance<StoreServerClient>()));
...
initHomeModule(){
  if (!GetIt.I.isRegistered<HomeUseCase>()) {
    ...
    instance.registerFactory<AdsUseCase>(() =>
        AdsUseCase(instance<Repository>()));

    /// Register view model
    instance.registerFactory<HomeViewModel>(() =>
        HomeViewModel(instance<HomeUseCase>() , instance<AdsUseCase>()));
